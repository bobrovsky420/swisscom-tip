...
TOOL_CONTRACTS = {
    ...
    "resolve": (StructuredGroundingRequest, StructuredGroundingResult,
                ...
                "as_of date inside its temporal_coverage (normally today; null valid_from and valid_through mean any "
                "date is covered), and context values for every required field of its "

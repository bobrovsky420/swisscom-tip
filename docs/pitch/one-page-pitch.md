...
Our prototype combines source ingestion, AI extraction, scoped retrieval, semantic ranking and a working MCP server. Evidence stays tied to its source and jurisdiction.
...
Our Zurich pilot demonstrates retrieval; reviewed knowledge and language validation come next.

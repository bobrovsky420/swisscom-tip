...
**v2 extension (11 September):** a paced recovery saved 389 further government pages (176 previously failed downloads plus 213 newly discovered links). They were added as new release parts without touching v1: 333 documents with 2,756 quotation facts in the assertion layer, and a concept layer of 377 evidence-cited candidates on 81 pages produced by running the knowledge-builder's V3 extraction with assistant-authored completions and reviews instead of a model API. Details: [v2 extension record](../pilots/2026-09-11-residence-v2-extension.md).

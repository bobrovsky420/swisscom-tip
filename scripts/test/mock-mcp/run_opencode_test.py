...
# --release-file/--release-id. Falls back to the local v5 build if the bundle is absent.
try:
    ...
    PILOT_RELEASE = ROOT / ".local/mvp/residence-semantic-2026-09-12-v5/release.json"
    PILOT_RELEASE_ID = "hackathon-residence-semantic-2026-09-12-v5"

...
if __name__=='__main__':
    ...
    parser.add_argument('--intermediate',type=Path,default=SOURCE,help='Intermediate export to read (default: 2026-09-11 snapshot)')
    parser.add_argument('--semantic',type=Path,default=OUTPUT,help='Semantic output directory (default: 2026-09-11 snapshot)')
    args=parser.parse_args()
    if not 0<=args.shard_index<args.shard_count: parser.error('Invalid shard index/count')
    SOURCE=args.intermediate.resolve(); OUTPUT=args.semantic.resolve()
